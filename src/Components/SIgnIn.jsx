...
function SIgnIn() { 
  ...
  return (
      <div className='flex justify-center items-center w-full' style={{height: "90vh"}}>
          <div className='border-2 border-gray-800 rounded-lg flex flex-col gap-5 px-4 justify-center items-center w-1/4 bg-gray-600' style={{height: '60vh'}}>
            <h1 className='font-bold text-5xl'>SIGN IN</h1>
            <form className='flex flex-col items-center' style={{width: '100%'}}
              onSubmit={(e) => login(e)}
            >  
              <Input name="emailorusername" className='w-full h-10' label="Email or Username" type="text" placeholder="Email or Username" />
